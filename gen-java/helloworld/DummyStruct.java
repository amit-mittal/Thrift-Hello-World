...
public class DummyStruct implements org.apache.thrift.TBase<DummyStruct, DummyStruct._Fields>, java.io.Serializable, Cloneable {
  ...
  static {
    schemes.put(StandardScheme.class, new DummyStructStandardSchemeFactory());
    schemes.put(TupleScheme.class, new DummyStructTupleSchemeFactory());
  }
  ...
  public DummyStruct setValue(long value) {
    this.value = value;
    setValueIsSet(true);
    return this;
  }
  ...
  public int compareTo(DummyStruct other) {
    ...
    DummyStruct typedOther = (DummyStruct)other;
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("DummyStruct(");
    boolean first = true;
  ...
  private static class DummyStructStandardSchemeFactory implements SchemeFactory {
    public DummyStructStandardScheme getScheme() {
      return new DummyStructStandardScheme();
    }
  }

  private static class DummyStructStandardScheme extends StandardScheme<DummyStruct> {
  ...
  private static class DummyStructTupleSchemeFactory implements SchemeFactory {
    public DummyStructTupleScheme getScheme() {
      return new DummyStructTupleScheme();
    }
  }

  private static class DummyStructTupleScheme extends TupleScheme<DummyStruct> {
